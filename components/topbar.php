<div class=nav-bar>
	<div class='logo flex'><a href=home.php><img src=../media/light-logo-1.png class=logo_img></a></div>
	<div class='search flex'><input type=text name=search id=Search class=search_bar></div>
	<div class='menu flex'>
