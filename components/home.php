    ...
    <div class="movie-box flex">
        ...
        <div class="movie-box_half flex">
            ...
            <div class="big-movie flex">
                <div class="big-movie_poster">
                    <?php 
                        $sql = "SELECT m.movie_id, title, poster, AVG(rating) FROM movie as m LEFT JOIN movie_rating as mra ON mra.movie_id = m.movie_id GROUP BY movie_id ORDER BY release_date DESC LIMIT 1";
                        $result = $conn->query($sql);
                        if ($result->num_rows > 0) {
                            while($row = $result->fetch_assoc()) {
                                $movieName = $row["title"];
                ...
                <div class="movie">
                    ...
                    <div class="movie_info flex">
                        ...
                        <div class="movie_info_btns flex"> 
                            <a href="#modal-one" class="like rate-btn" onclick="homeRate(<?=$row['movie_id']?>, 'home-mov')"><?=$starBtnVal?> ★</a>
