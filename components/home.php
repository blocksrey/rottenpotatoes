...
<div class='wrapper'>
	...
	<div class='movie-box flex'>
		...
		<div class='movie-box_half flex'>
			...
			<div class='big-movie flex'>
				<div class='big-movie_poster'>
					<img src='https://assets.mubicdn.net/media/notebook/post_media/31814/images-w1400.jpg?1606176049'>
				</div>
				<div class='big-movie_info flex' onclick="location.href='movie.php'">
	...
	<div class='list-box_half flex'>
		...
		<div class='explore flex'>
			...
			<div class='movie'>
				<div class='movie_poster'>
					<a href='movie.php'><img class='mov' src='https://assets.mubi.com/media/notebook/post_media/19893/images-w1400.jpg?1449196747'></a>
				</div>
				<div class='movie_info flex'>
					<div class='movie_info_text'>
			...
			<div class='movie'>
				<div class='movie_poster'>
					<a href=#><img src='../media/potato.png' class='like'></a>
				</div>
